...
{if(isStandardPort(this.port)){this.port=ports[this.scheme];}
...
return true;}
return false;};this.isDefaultPort=function()
{if(!this.port)return true;for(var schema in ports){if(schema==this.scheme&&this.port!=ports[this.scheme])
return false;}
